...
* The traceability matrix was generated and can be found here: [Traceability matrix.xlsx]()  [SQL section](https://github.com/Dumitru-Cristina/Proiect-Practic-Testare-Manuala/blob/main/Traceability%20matrix.xlsx)
