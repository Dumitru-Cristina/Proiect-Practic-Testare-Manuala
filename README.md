...
* The traceability matrix was generated and can be found here: [Traceability matrix.xlsx]()  [Traceabilitiy matrix](https://github.com/Dumitru-Cristina/Proiect-Practic-Testare-Manuala/blob/main/Traceability%20matrix.xlsx)
